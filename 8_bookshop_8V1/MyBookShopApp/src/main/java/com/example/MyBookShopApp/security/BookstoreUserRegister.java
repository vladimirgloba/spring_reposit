...
public class BookstoreUserRegister {
    ...
    public ContactConfirmationResponse jwtLogin(ContactConfirmationPayload payload) {
        ...
        System.out.println(userDetails.getBookstoreUser().getEmail());
        System.out.println(userDetails.getBookstoreUser().getId());
        System.out.println(userDetails.getBookstoreUser().getName());
        System.out.println(userDetails.getBookstoreUser().getPhone());
        System.out.println(userDetails.getBookstoreUser().getPassword());
        String jwtToken = jwtUtil.generateToken(userDetails);
        ContactConfirmationResponse response = new ContactConfirmationResponse();
        response.setResult(jwtToken);

        authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(payload.getContact(),
                "$2a$10$97QnWHMV5bY4q7zEWVfTsu8ewKMVfdHyZYrorj22PJbanH/JLXD0a"));
