...
public interface GenreRepository extends JpaRepository<GenreEntity, Integer> {
    ...
    @Query(value = "select * from genre where id in (select genre_id from book2genre where book_id=?)",nativeQuery = true)
    List<GenreEntity> selectGenreByBookId(Integer bookId);
